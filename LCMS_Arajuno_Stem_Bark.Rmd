...
# Main path
ppath <- "C:/Users/F4ss0/Documents/Ikiam21062022/Arajuno_Stem_Bark/"
# Log system
init_log(log_file = paste0(ppath, "Result/LCMS/LCMS_EEUU_log.txt"))
...
data <- read_from_excel(file = "Data/LCMS_to_R.xlsx", sheet = 2, 
...
visualizations(mode, prefix = paste0(ppath, "Figure/LCMS/", "Low_Detection_EEUU"))
...
# Some statistics after low detection algorithm
visualizations(corrected_no_blank, prefix = paste0(ppath, "Figure/LCMS/", "No_Blank_EEUU"))
...
ggplot(scores,
  ...
  geom_point(size = 3) +
  guides(x=guide_axis(title = "PC1 (31.65 %)"),
         y=guide_axis(title = "PC2 (19.46 %)")) +
  theme_classic()
# Save plot
