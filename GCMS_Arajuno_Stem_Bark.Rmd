---
title: "Untargeted characterization of Amazonian barks extracts plants by Liquid and Gas Chromatography - Mass Spectrometry"
subtitle: "Gas Chromatography - Mass Spectrometry (GC-MS) data analysis"
...
corrected_no_blank <- flag_contaminants(corrected, blank_col = "Group", blank_label = "Blank", flag_thresh = 0.05, flag_label = "Contaminant")
...
ggplot(scores, aes(PC1, PC2, shape = Species, color = Species)) +
  geom_point(size = 3) +
  guides(x=guide_axis(title = "PC1 (35.96 %)"), y=guide_axis(title = "PC2 (21.96 %)")) +
  theme_classic()
# Save plot
...
ggplot(loadings, aes(PC1, PC2)) + 
  ...
  ggrepel::geom_label_repel(data = ei_compouds, aes(label = Compound), box.padding = 0.8, label.padding = 0.27, label.r = 0.3, cex = 3) +
  guides(x=guide_axis(title = "PC1 (35.96 %)"), y=guide_axis(title = "PC2 (21.96 %)")) +
