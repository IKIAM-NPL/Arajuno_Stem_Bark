...
# Plotting results
figure_1b <- ggplot(loadings, aes(PC1, PC2)) +
  ...
  theme(legend.position = c(0.865, 0.09),
...
# Heatmap plot
figure_1c <- plot_grid(gg_legend_fn,
          gg_heatmap, ncol = 1,
...
#      width = 130, height = 130, units = "mm", dpi = 300, scale = 2.5)
# (*.jpg) file
#ggsave(filename = "Result/LCMS/Figure_1.jpg", plot = figure_one,
#      width = 130, height = 130, units = "mm", dpi = 300, scale = 2.5)
