...
# Save plot
#ggsave('Result/LCMS/Firts_LCMS_Loadings_to_DQ.png', width = 6, height = 5, device='png', dpi="print")
...
gcms_hm
# Save heatmap plot
#ggsave(filename = "Result/LCMS/Firts_LCMS_Heatmap_to_DQ.pdf", plot = gcms_hm,
