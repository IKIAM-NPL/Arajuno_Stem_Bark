...
data_2 <- read_from_excel(file = "Data/Second_LCMS_Dataset_to_R.xlsx", sheet = 3, 
...
modes_2 <- construct_metabosets(exprs = data$exprs, 
...
# Data extraction
mode_test2 <- modes_2$RP_NEG
# Boxplot of raw data
raw_bp2 <- plot_sample_boxplots(mode_test2,
                               order_by = "Group",
                               fill_by = "Group")
# PCA of raw data
raw_pca2 <- plot_pca(mode_test2,
                       center = TRUE,
                       shape = "Group",
                       color = "Group")
...
# Data extraction
mode_2 <- modes_2$RP_NEG
# Change 0 value to NA
mode_2 <- mark_nas(mode_2, value = 0)
...
# Low detection rate
mode_2 <- flag_detection(mode_2, qc_limit = 3/4, group_limit = 2/3)
...
# Drift correction
corrected_2 <- correct_drift(mode_2)
# Flag low quality features
corrected_2 <- flag_quality(corrected_2)
...
# Boxplot
corr_bp2 <- plot_sample_boxplots(corrected_2,
                                      order_by = "Group",
                                      fill_by = "Group")
# PCA
corr_pca2 <- plot_pca(corrected_2,
                        center = TRUE,
                        shape = "Group",
                        color = "Group") 
# Plot
...
corrected_no_blank2 <- flag_contaminants(corrected_2,
                                        blank_col = "Group",
                                        blank_label = "PB",
                                        flag_thresh = 0.80,
                                        flag_label = "Contaminant")
# Removal blank group from dataset
corrected_no_blank2 <- corrected_no_blank2[, corrected_no_blank2$Group != "PB"]
...
corrected_no_qc2 <- drop_qcs(corrected_no_blank2)
...
# Boxplot
no_qc_bp2 <- plot_sample_boxplots(corrected_no_qc2,
                                 order_by = "Group",
                                 fill_by = "Group")
# PCA
no_qc_pca2 <- plot_pca(corrected_no_qc2,
                      center = TRUE,
                      shape = "Group",
                      color = "Group")
# Plot
...
clustered_2 <- cluster_features(corrected_no_qc2,
                              rt_window = 1/60,
                              all_features = TRUE,
                              corr_thresh = 0.90,
                              d_thresh = 0.8
...
compressed_2 <- compress_clusters(clustered_2)
...
# Boxplot
compr_bp2 <- plot_sample_boxplots(compressed_2,
                                 order_by = "Group",
                                 fill_by = "Group")
# PCA
compr_pca2 <- plot_pca(compressed_2,
                      center = TRUE,
                      shape = "Group",
                      color = "Group")
# Plot
...
# To clean data
set.seed(123)
imputed_2 <- impute_rf(compressed_2)
...
# Boxplot
imp_bp2 <- plot_sample_boxplots(imputed_2,
                               order_by = "Group",
                               fill_by = "Group")
# PCA
imp_pca2 <- plot_pca(imputed_2,
                    center = TRUE,
                    shape = "Group",
                    color = "Group")
# Plot
...
# Extract clean data
no_flag2 <- drop_flagged(imputed_2)
...
figure_1a <- ggplot(scores2,
  ...
  theme(legend.position = c(0.87, 0.132),
